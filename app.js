...
class AuthManager {
    constructor() {
        this.PASSWORD = "vsosh2024"; // Пароль прописан в коде
        this.SESSION_KEY = "vsosh_authenticated";
        this.SESSION_DURATION = 8 * 60 * 60 * 1000; // 8 часов в миллисекундах
    }
...
class VsoshApp {
    constructor() {
        ...
        if (!this.authManager.isAuthenticated()) {
            ...
            this.initLoginForm();
            return; // Не инициализируем основное приложение
        }
...
document.addEventListener('DOMContentLoaded', () => {
        ...
        if (loginForm) {
            loginForm.addEventListener('submit', (e) => {
                ...
                if (this.authManager.authenticate(password)) {
                    this.authManager.hideLoginScreen();
                    this.init(); // Теперь инициализируем основное приложение
                } else {
    ...
    // Метод для выхода (можно добавить кнопку в интерфейс)
    logout() {
